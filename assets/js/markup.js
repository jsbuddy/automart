const Markup = {
  car: car => `
    <div class="dashboard-item">
        ...
        <div class="actions flex justify-between">
            <div class="buttons">
                <a href="${Auth.origin}/car/index.html?id=${car.id}" class="btn primary sm outline">View</a>
  ...
  order: order => `
    <div class="dashboard-item">
        ...
        <div class="actions flex justify-between">
            <div>
                <a href="${Auth.origin}/car/index.html?id=${order.car.id}" class="btn primary sm outline">View</a>
  ...
  flagAdmin: flag => `
    <div class="dashboard-item">
          ...
          <div>
              <div class="seller flex justify-between">
                  <div class="name flex align-center">
                      ...
                      <span class="text-italic" style="font-style: italic">on ${formatDate((flag.createdOn))}</span>
                  </div>
              </div>
      ...
      <div class="actions flex justify-between">
          <div>
              <a href="${Auth.origin}/car/index.html?id=${flag.car.id}" class="btn primary sm outline">View</a>
    ...
    return `
      <div class="left">
          <div class="carousel">
              ${!car.images.length ? `
                <div class="image">
                    <img src="${location.origin}/assets/images/placeholder.png" alt="" class="cover">
                </div>
               ` : ''}
              ${car.images.length ? `
